...
public class Expense {
    ...
    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "operational_day_id") private OperationalDay operationalDay;
    ...
    @Enumerated(EnumType.STRING) @Column(nullable = false) private ExpenseClassification classification;
    @Enumerated(EnumType.STRING) @Column(name = "allocation_method") private AllocationMethod allocationMethod;
    @Column(name = "professional_percentage", precision = 5, scale = 4) private BigDecimal professionalPercentage;
    @Column(name = "professional_fixed_amount", precision = 14, scale = 2) private BigDecimal professionalFixedAmount;
    ...
    public static Expense create(Vehicle vehicle, OperationalDay day, Shift shift, ExpenseCategory category,
                                 LocalDate expenseDate, LocalDate competenceDate, LocalDate paidDate,
                                 BigDecimal amount, ExpenseClassification classification,
                                 AllocationMethod method, BigDecimal professionalPercentage,
                                 BigDecimal professionalFixedAmount, String adjustmentReason, String notes) {
            ...
            switch (normalizedMethod) {
                ...
                case MANUAL_PERCENTAGE -> {
                    if (normalizedPercentage == null || normalizedPercentage.signum() <= 0
                        ...
                        throw new IllegalArgumentException("Percentual profissional deve estar entre 0 e 1, sem os extremos");
                    }
                ...
                case FIXED_AMOUNT -> {
                    if (normalizedFixedAmount == null || normalizedFixedAmount.signum() <= 0
                        ...
                        throw new IllegalArgumentException("Valor profissional fixo deve ser maior que zero e menor que o valor do gasto");
                    }
                    if (normalizedReason == null) {
                        throw new IllegalArgumentException("Justificativa do ajuste é obrigatória");
                    }
    ...
    public UUID getId(){return id;} public Vehicle getVehicle(){return vehicle;} public OperationalDay getOperationalDay(){return operationalDay;}
    public Shift getShift(){return shift;} public ExpenseCategory getCategory(){return category;} public LocalDate getExpenseDate(){return expenseDate;}
    public LocalDate getCompetenceDate(){return competenceDate;} public LocalDate getPaidDate(){return paidDate;} public BigDecimal getAmount(){return amount;}
    public ExpenseClassification getClassification(){return classification;} public AllocationMethod getAllocationMethod(){return allocationMethod;}
    public BigDecimal getProfessionalPercentage(){return professionalPercentage;} public BigDecimal getProfessionalFixedAmount(){return professionalFixedAmount;}
    public String getAdjustmentReason(){return adjustmentReason;} public String getNotes(){return notes;} public String getStatus(){return status;}
}
